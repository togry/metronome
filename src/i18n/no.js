...
const no = {
  ...
  scoreUntitled:   (n) => `Partitur ${n}`,
  tooltipSelectScore: 'Velg hvilket partitur du vil arbeide med',
  tooltipAddScore:    'Legg til et partitur',
  tooltipDeleteScore: 'Slett dette partituret',
  confirmDeleteScore: 'Slette dette partituret? Det kan ikke gjenopprettes.',
  btnScore:        'NOTE',
  btnThemeDark:    '☀',
  btnThemeLight:   '🌙',
